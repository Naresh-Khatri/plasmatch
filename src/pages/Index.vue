  ...
  <q-page class="">
    <div class="hello">
      ...
      >
        ...
        <!--Hero-->
        <div class="pt-24 primary-gradient">
          <div
          ...
          >
            ...
            <vue-typed-js
              :strings="[
                ...
                'कृपया एक जीवन बचाने में मदद करें',
                'దయచేసి ఒక ప్రాణాన్ని రక్షించడానికి సహాయం చేయండి',
                'தயவுசெய்து ஒரு உயிரைக் காப்பாற்ற உதவுங்கள்',
                'براہ کرم جان بچانے میں مدد کریں',
                'একটি জীবন বাঁচাতে সাহায্য করুন'
              ]"
              loop="true"
              fadeOut="true"
              :backDelay="2000"
            >
              <h1 class="my-4 text-3xl font-bold" style="text-align:center">
          ...
          <div style="margin-top:400px">
            ...
            >
              <router-link
                ...
                style="padding:5px"
              >
                <q-btn color="green-4" label="Register as Donor" />
              </router-link>
              <router-link
                class="router-text"
                ...
                style="padding:5px"
              >
                <q-btn color="secondary" label="Register as Pateint" />
              </router-link>
            </div>
            <div style="text-align:center; padding:10px; margin-top:10px">
              Plasma from recovered COVID-19 patients is urgently needed across
              hospitals in India.
            </div>
            <div
          ...
          <div class="container mx-auto flex flex-wrap pt-4 ">
            ...
            >
              ...
              >
                ...
                <div
                  class="w-full font-bold text-gray-800 py-6"
                  style="padding:.5em; font-size:3em"
                >
                  For Donors
                </div>
                <div
